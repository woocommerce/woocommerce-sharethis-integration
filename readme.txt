...
Provides integration between ShareThis and WooCommerce.

== Description ==

This plugin provides the integration between ShareThis and the WooCommerce plugin.
...
Contributions are welcome via the [GitHub repository](https://github.com/woothemes/woocommerce-sharethis-integration).
...
Starting the WooCommerce 2.1 release, the ShareThis integration for WooCommerce is no longer part of the WooCommerce plugin.
